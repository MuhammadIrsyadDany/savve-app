...
<div class="anim-fade-up delay-1 flex justify-between items-start mb-6">
    ...
    <div class="flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-bold flex-shrink-0"
...
<div class="grid grid-cols-4 gap-4 mb-6">
    ...
    <div class="stat-card anim-fade-up delay-2 bg-white rounded-2xl p-5 border border-gray-100"
        ...
        <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Transaksi Saya Hari Ini</p>
        <p class="text-3xl font-black text-gray-900">{{ $transaksiHariIni }}</p>
    ...
    <div class="stat-card anim-fade-up delay-3 bg-white rounded-2xl p-5 border border-gray-100"
        ...
        <p class="text-3xl font-black text-gray-900">{{ $belumDiambil }}</p>
        <div class="mt-3 h-1 bg-gray-100 rounded-full overflow-hidden">
    ...
    <div class="stat-card anim-fade-up delay-4 bg-white rounded-2xl p-5 border border-gray-100"
        ...
        <p class="text-3xl font-black text-gray-900">{{ $sudahDiambil }}</p>
        <div class="mt-3 h-1 bg-gray-100 rounded-full overflow-hidden">
    ...
    <div class="stat-card anim-fade-up delay-5 rounded-2xl p-5 text-white relative overflow-hidden"
        ...
        <div class="absolute -top-4 -right-8 w-16 h-16 rounded-full" style="background: rgba(167,139,250,0.1)"></div>
    </div>
...
<div class="anim-fade-up delay-6 mb-6">
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <a href="{{ route('kasir.transaksi.create') }}"
            ...
            <div class="absolute -top-4 -right-4 w-20 h-20 rounded-full" style="background: rgba(167,139,250,0.08)"></div>
        </a>
        ...
        <a href="{{ route('kasir.pengambilan.index') }}"
            ...
            <h3 class="text-xl font-black mb-2" style="color: #1e1035">Pengambilan Barang</h3>
            ...
            <div class="absolute -bottom-6 -right-6 w-28 h-28 rounded-full" style="background: rgba(91,33,182,0.04)"></div>
        </a>
    </div>
</div>
...
<div class="anim-fade-up delay-7 bg-white rounded-2xl border border-gray-100 overflow-hidden"
    ...
    <div class="flex justify-between items-center px-5 py-4"
        ...
        <a href="{{ route('kasir.transaksi.index') }}"
            class="text-xs font-bold hover:underline transition" style="color: #7c3aed">
            Lihat Semua →
        </a>
    </div>
        ...
        <table class="w-full text-sm">
            <thead>
                <tr style="background: #fdfbff; border-bottom: 1px solid #ede9fe">
                    <th class="px-5 py-3 text-left whitespace-nowrap" style="font-size:10px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:0.06em">ID Transaksi</th>
                    ...
                    <th class="px-5 py-3 text-left whitespace-nowrap" style="font-size:10px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:0.06em">Jenis Barang</th>
                ...
                <tr class="table-row" style="border-top: 1px solid #f5f3ff">
                    ...
                    <td class="px-5 py-4 text-gray-500 text-sm">
                        ...
                        @if($t->details->count() > 1)
                            <span class="text-xs" style="color: #7c3aed">+{{ $t->details->count() - 1 }}</span>
                        @endif
                    </td>
