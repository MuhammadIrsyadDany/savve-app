...
@section('content')
    ...
    <div class="anim-fade-up delay-1 flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-6">
        <div>
            ...
            <h1 class="text-xl lg:text-2xl font-black text-gray-900">Edit Transaksi</h1>
    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="flex-1 min-w-0">
            ...
            <form action="{{ route('kasir.transaksi.update', $transaksi) }}" method="POST" id="form-transaksi">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="nama_penitip"
                                value="{{ old('nama_penitip', $transaksi->nama_penitip) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="no_whatsapp"
                                value="{{ old('no_whatsapp', $transaksi->no_whatsapp) }}"
                                class="w-full rounded-xl px-4 py-3 text-sm transition"
                                style="background: #faf5ff; border: 1.5px solid #ede9fe; color: #374151"
                ...
                <div class="anim-fade-up delay-3 bg-white rounded-2xl border border-gray-100 p-5 lg:p-6 mb-4"
                    ...
                    <div id="items-container" class="space-y-4">
                        @foreach ($transaksi->details as $idx => $detail)
                            ...
                            @foreach (['QRIS' => '📱', 'Cash' => '💵', 'Web' => '🌐'] as $metode => $icon)
                                <label class="metode-label cursor-pointer">
                                    <input type="radio" name="metode_bayar" value="{{ $metode }}"
                                        ...
                                        {{ old('metode_bayar', $transaksi->metode_bayar) === $metode ? 'checked' : '' }}>
                ...
                <div class="anim-fade-up delay-4 bg-white rounded-2xl border border-gray-100 p-5 lg:p-6 mb-4"
                    ...
                    <input type="hidden" name="hapus_foto_penitipan" id="hapus_foto_penitipan_input" value="0">

                    <div id="foto-preview-wrapper" class="{{ $transaksi->foto_penitipan ? '' : 'hidden' }} mb-3">
                        <div class="relative rounded-xl overflow-hidden" style="border: 1.5px solid #ddd6fe">
                            <img id="foto-preview"
                                src="{{ $transaksi->foto_penitipan ? asset('storage/' . $transaksi->foto_penitipan) : '' }}"
                                alt="Preview" class="w-full max-h-52 object-cover">
                            <div
                    ...
                    <div id="foto-buttons"
                        class="{{ $transaksi->foto_penitipan ? 'hidden' : '' }} grid grid-cols-2 gap-3">
                ...
                <div class="anim-fade-up delay-5 flex gap-3">
                    ...
                    <a href="{{ route('kasir.transaksi.show', $transaksi) }}" id="btn-batal"
...
${ukuranButtons}
    ...
    <div class="jenis-barang-wrapper">
        ...
        function hapusFoto() {
            ...
            const hapusFlag = document.getElementById('hapus_foto_penitipan_input');
