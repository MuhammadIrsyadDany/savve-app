...
<div class="anim-fade-up delay-1 flex justify-between items-start mb-6">
    <div>
        ...
        <h1 class="text-2xl font-black text-gray-900">Kelola Event</h1>
                ...
                <tr class="table-row" style="border-top: 1px solid #f1f5f9">
                    ...
                    <td class="px-5 py-4">
                        ...
                        <div class="flex gap-1.5 flex-wrap">
                            ...
                            <span class="px-2 py-1 rounded-lg text-xs font-bold whitespace-nowrap"
                    ...
                    <td class="px-5 py-4 whitespace-nowrap">
                        <div class="flex items-center gap-3">
                            <a href="{{ route('admin.events.edit', $event) }}"
                                ...
                                style="color: #1a3a6b">Edit</a>
                            <form action="{{ route('admin.events.destroy', $event) }}" method="POST"
                                onsubmit="return confirm('Hapus event ini?')">
                                @csrf @method('DELETE')
                                <button type="submit" class="text-xs font-bold hover:underline transition"
