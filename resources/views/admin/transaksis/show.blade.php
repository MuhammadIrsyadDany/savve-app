...
<div class="max-w-2xl space-y-4">
    <div class="bg-white rounded-xl shadow p-6">
        <div class="flex justify-between items-start mb-4">
            <div>
                ...
                <p class="text-2xl font-bold font-mono text-blue-600">{{ $transaksi->nomor_transaksi }}</p>
            </div>
        ...
        <div class="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
                <p class="text-gray-400">Waktu Pengambilan</p>
                <p class="font-medium">{{ $transaksi->waktu_pengambilan->format('d M Y H:i') }}</p>
            </div>
            @endif
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr>
                    <td class="px-3 py-2">{{ $detail->nama_barang_custom ?? $detail->kategori->nama_kategori }}</td>
    ...
    <a href="{{ route('admin.transaksis.index') }}" class="inline-block px-6 py-2 rounded-lg border hover:bg-gray-50">
        ← Kembali
    </a>
</div>
@endsection