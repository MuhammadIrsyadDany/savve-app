...
<div class="anim-fade-up delay-1 flex justify-between items-start mb-6">
    <div>
        ...
        <h1 class="text-2xl font-black text-gray-900">Kelola Kasir</h1>
        ...
        <table class="w-full text-sm">
            <thead>
                <tr style="background: #f8faff; border-bottom: 2px solid #e2e8f0">
                    ...
                    <th class="px-5 py-4 text-left whitespace-nowrap" style="font-size:10px;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:0.06em">Transaksi Hari Ini</th>
